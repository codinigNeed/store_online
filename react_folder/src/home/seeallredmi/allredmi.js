...
import {produitredmi} from "../redmi/redmiprduit";
...
import './seeallpc.css';
export default function AllRedmi(){
    ...
    const  redmi = redmis.filter((t)=>{return t.categorie_id == 5})
