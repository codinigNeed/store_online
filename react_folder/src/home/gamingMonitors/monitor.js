...
import { produitmonitor } from "./TAbleMoniture";
...
export default function Monitor(){
    ...
    const  monitor = monitors.filter((t)=>{return t.categorie_id == 4})
        ...
        <div className="div-imag-pc">
            <div>
                ...
                <div className="aseeAllpc">
                    <Link to={'/Allgamingmontor'} className="see">
                    <div className="seeAll">see all product</div>
                    </Link>
                </div>
            </div>
            {monitor.slice(0,4).map((item)=>{
